...
- On MakerWorld: hover a model card and press `Alt+Q`.
...
- Opening the popup loads the latest Alt+Q-captured model into that UI automatically.
...
3. Hover a model card and press `Alt+Q`.
